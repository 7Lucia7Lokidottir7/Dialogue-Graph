...
namespace PG.DialogueGraph
{
    ...
    public class LocalizationDialogueManager : MonoBehaviour
    {
        ...
        void ShowNode(string nodeID)
        {
            ...
            {
                _speakerNameObject.SetText(LocalizationSystem.instance.GetLocalizedValue(_currentDialogueNode.speakerName));
                _dialogueTextObject.SetText(LocalizationSystem.instance.GetLocalizedValue(_currentDialogueNode.dialogueText));
